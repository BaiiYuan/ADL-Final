...
image = ['b/butte/00000005.jpg', 'b/butte/00000001.jpg', 'b/badlands/00000001.jpg', 'b/botanical_garden/00000002.jpg', 'b/beach/00000001.jpg']
image_root = '../data_256'
        ...
        for c, img in enumerate(image):
            ...
            for mask_width in [16, 32, 48, 64]:
                ...
                for i, data in enumerate(islice(dataset, self.opt.how_many)):
                    ...
                    save.extend(out)
            # embed()
            save_img_test(torch.cat(save), f"pretrained_task1_img{c}.png")
