...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='place2_go', help='name of the experiment.')
        ...
        parser.add_argument('--mask_type', type=int, default=[4],
                            ...
                            '2: random irregular mask. 3: external irregular mask. 4: bar mask [0],[1,2],[1,2,3]')
        ...
        parser.add_argument('--resize_or_crop', type=str, default='', help='scaling and cropping of images at load time [resize_and_crop|crop|]')
        ...
        parser.add_argument('--display_port', type=int, default=8617, help='visidom port of the web display')
